...
If you want to check if your configuration is parsed correctly, you can use
`lemurs --show-config`. This will print all settings, including default values,
in proper TOML output.
